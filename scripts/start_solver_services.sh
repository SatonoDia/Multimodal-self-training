...
CUDA_VISIBLE_DEVICES=0 python vllm_service_init/start_vllm_server.py --port 5000 --model_path "$model_path" --gpu_mem_util 0.9 --tensor_parallel_size 1 > solver_service.log 2>&1 &
solver_pid=$!
